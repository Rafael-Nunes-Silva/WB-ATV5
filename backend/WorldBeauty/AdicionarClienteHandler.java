...
public class AdicionarClienteHandler implements HttpHandler {
    public void handle(HttpExchange he) throws IOException {
        ...
        String response = "<h1>Adicionar Cliente</h1>";
        ...
        try {
            ...
            Empresa.AdicionarCliente(new Cliente(
                (String)json.get("nome"),
                (String)json.get("nomeSocial"),
                (String)json.get("genero"),
                (CPF)json.get("CPF"),
                new ArrayList<RG>(Arrays.asList((RG[])json.get("RGs"))),
                (Date)json.get("dataCadastro"),
                new ArrayList<Telefone>(Arrays.asList((Telefone[])json.get("telefones"))),
                new ArrayList<Produto>(Arrays.asList((Produto[])json.get("produtosConsumidos"))),
                new ArrayList<Servico>(Arrays.asList((Servico[])json.get("servicosConsumidos")))
            ));
